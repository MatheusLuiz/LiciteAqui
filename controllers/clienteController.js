...
class ClienteController {
  ...
  static async atualizar(req, res) {
    try {
      ...
      const { id_cliente, cnpj, razao_social, nome_fantasia, status, usuario } =
        req.body;
      const result = await ClienteModel.atualizarCliente(
        id_cliente,
        cnpj,
        razao_social,
        nome_fantasia,
  ...
  static async listar(req, res) {
    try {
      ...
      if (!result || result.data === null) {
        return res
          .status(404)
          .json({ success: false, message: "Nenhum cliente encontrado." });
      }
  ...
  static async listarClientesInativos(req, res) {
    try {
      ...
      return res
        ...
        .json({
          success: true,
          message: "Clientes inativos listados com sucesso.",
          data: clientes,
        });
    } catch (error) {
      ...
      return res
        ...
        .json({
          success: false,
          message: "Erro ao listar clientes inativos.",
          error: error.message,
        });
    }
  }
    ...
    try {
      ...
      if (clientes.length === 0) {
        return res
          ...
          .json({
            success: false,
            message: "Nenhum cliente suspenso encontrado.",
          });
      }
      return res
        .status(200)
        .json({
          success: true,
          message: "Clientes suspensos listados com sucesso.",
          data: clientes,
        });
    } catch (error) {
      ...
      return res
        ...
        .json({
          success: false,
          message: "Erro ao listar clientes suspensos.",
          error: error.message,
        });
    }
  }
  ...
  static async listarTodosClientes(req, res) {
    try {
      ...
      return res
        ...
        .json({
          success: true,
          message: "Todos os clientes listados com sucesso.",
          data: clientes,
        });
    } catch (error) {
